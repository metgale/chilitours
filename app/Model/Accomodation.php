...
class Accomodation extends AppModel {
    ...
    public function createWithAttachments($data) {
        ...
        throw new Exception(__("This accomodation  could not be saved. Please try again"));
    }
